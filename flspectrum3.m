function [emwav,fl,av]=flspectrum3(r,c,data)
...
av=mean(B+G+R); %find the mean combined R, G, and B Reflectance in ROI

data.cube(:,:,7)=(data.cube(:,:,7)+data.cube(:,:,6)+data.cube(:,:,5))/av;  %normalize the Blue Reflect. image by the mean value in the ROI
