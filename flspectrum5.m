function [emwav,fl,av]=flspectrum5(r,c,data)
...
av=mean(B+G); %find the mean Blue Reflectance in ROI

data.cube(:,:,7)=(data.cube(:,:,7)+data.cube(:,:,6))/av;  %normalize the Blue Reflect. image by the mean value in the ROI
