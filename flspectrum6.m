function [emwav,fl,av]=flspectrum6(r,c,data)
...
av=mean(R); %find the mean Blue Reflectance in ROI

data.cube(:,:,5)=data.cube(:,:,5)/av;  %normalize the Red Reflect. image by the mean value in the ROI
