function [emwav,fl,avB]=flspectrum2(r,c,data)
...
avB=mean(B) %find the mean Blue Reflectance in ROI
data.cube(:,:,7)=data.cube(:,:,7)/avB;  %normalize the Blue Reflect. image by the mean value in the ROI
