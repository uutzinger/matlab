function hh = myerrorbar(x, y, l,u,symbol)
%ERRORBAR Error bar plot.
%
%   This is the original errorbar routine but does not connect x,y with a
%   line and plots the bar with the line symbol specified.
%   Modified UU, UofA Dec. 2003
%
...
xb(5:9:end,:) = xr;  % top
xb(6:9:end,:) = NaN; 
xb(7:9:end,:) = xl;  % bottom
xb(8:9:end,:) = xr;  % bottom
xb(9:9:end,:) = NaN;
